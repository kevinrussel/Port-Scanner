...
class Packet:
    ...
    def generate_tmp_tcp_header(self):
        tmp_tcp_header = pack("!HHLLHH",self.src_port,self.dest_port,self.seq_num,self.ack_num,self.data_offset_res_flags,self.window_size)
    ...
    def generate_packet(self):
        ...
        final_tcp_header = pack("!HHLLHH",self.src_port,self.dest_port,self.seq_num,self.ack_num,self.data_offset_res_flags,self.window_size)
